---
title: "03.60 – XGBoost Baseline by City (Multi-Day Forecasts with Enhanced Features)"
format: html
jupyter: python3
----------------
...
# Target columns are now based on t2m
...
# MODIFIED: iy_train is now a DataFrame with all target columns
iy_train = train_df[target_cols]
...
# MODIFIED: models now stores a single MultiOutputRegressor
...
# MODIFIED: Predicts all targets at once
...
for i, target_col in enumerate(target_cols):
    ...
    print(importance_df.head(10)) # Print top 10 features for brevity

    # Plotting the top N feature importances for each
    plt.figure(figsize=(12, 6))
    sns.barplot(x='Importance', y='Feature', data=importance_df.head(10), palette='viridis')
    plt.title(f'Top 10 Feature Importances for {target_col} Model')
